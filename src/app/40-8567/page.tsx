...
export const Qode408567Page: React.FC<Qode408567PageProps> = ({ ...rest }) => {
  return (
    <>
      ...
      >
        ...
        >
          {/* name="Logo" id="I40:8568;1:3092" type="FRAME" */}
          <div
            style={{
              display: "flex",
              padding: "16px 0px",
          ...
          >
            {/* name="logo" id="I40:8568;635:31404" type="INSTANCE" */}
            <QodeCustom61606
          ...
          {/* name="V-Menu" id="I40:8568;1:3094" type="FRAME" */}
          <div
            style={{
              display: "flex",
              padding: "16px 8px",
          ...
          >
            {/* name="Navbar/Menu" id="I40:8568;4:124" type="INSTANCE" */}
            <QodeCustom433
              style={{
                display: "flex",
                width: "84px",
            ...
            />
            {/* name="Navbar/Menu" id="I40:8568;16:5813" type="INSTANCE" */}
            <QodeCustom433
              style={{
                display: "flex",
                width: "84px",
            ...
            />
            {/* name="Navbar/Menu" id="I40:8568;4:54" type="INSTANCE" */}
            <QodeCustom433
              style={{
                display: "flex",
                width: "84px",
            ...
            />
            {/* name="Navbar/Menu" id="I40:8568;4:95" type="INSTANCE" */}
            <QodeCustom433
              style={{
                display: "flex",
                width: "84px",
          ...
          {/* name="Btm" id="I40:8568;1:3098" type="FRAME" */}
          <div
            style={{
              display: "flex",
              padding: "16px 0px",
          ...
          >
            {/* name="Profile" id="I40:8568;1:3099" type="INSTANCE" */}
            <Flex
              style={{
                display: "flex",
                flexDirection: "column",
            ...
            >
              {/* name="Button" id="I40:8568;1:3099;5007:11919" type="INSTANCE" */}
              <QodeButton
                style={{
                  display: "flex",
            ...
            {/* name="Profile" id="I40:8568;1:3100" type="INSTANCE" */}
            <Flex
              style={{
                display: "flex",
                flexDirection: "column",
            ...
            >
              {/* name="Button" id="I40:8568;1:3100;5007:11919" type="INSTANCE" */}
              <QodeButton
                style={{
                  display: "flex",
                  height: "var(--size-height-controlheightlg, 40px)",
