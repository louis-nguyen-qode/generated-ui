      ...
      <div
        style={{
          ...{
            ...
            borderRight: "1px solid var(--border-border-primary-10, #64b9f5)",
            borderBottom: "1px solid var(--border-border-primary-10, #64b9f5)",
            borderLeft: "1px solid var(--border-border-primary-10, #64b9f5)",
            background:
