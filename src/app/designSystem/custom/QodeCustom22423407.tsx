...
export interface QodeCustom22423407Props {}

export const QodeCustom22423407: React.FC<
  QodeCustom22423407Props & { style?: CSSProperties }
> = ({ style, ...rest }) => {
  return (
    <>
      ...
      <div
        style={{
          ...{ width: "248px", height: "248px", flexShrink: "0" },
          ...style,
        }}
      >
        ...
        >
          ...
          <QodeSvg22423409
            style={{
              ...{ width: "100px", height: "200px", flexShrink: "0" },
              ...{},
            }}
            {...{}}
          />
        ...
        >
          ...
          <div
            style={{
              ...{ width: "78.22px", height: "77.846px", flexShrink: "0" },
              ...{},
            }}
          >
