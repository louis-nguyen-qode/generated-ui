...
export interface QodeCustom996876Props {}

export const QodeCustom996876: React.FC<
  QodeCustom996876Props & { style?: CSSProperties }
> = ({ ...rest }) => {
  return (
    <>
        ...
        >
          ...
          <QodeCustom18210113
            ...
            {...{
              showClear: true,
              suffix: "SUF",
              title: "Senior Software Engineer opportunity - [Company name]",
              prefix: "PRE",
