...
type ConvertToCamelCase<S extends string> = S extends `${infer P}-${infer R}`
  ? `${Capitalize<P>}${ConvertToCamelCase<R>}`
  : Capitalize<S>;

type FunctionName = `Qode${ConvertToCamelCase<typeof functionNames[number]>}`;

// Generate functions dynamically
const createFunctions = <T extends string>(names: T[]): Record<FunctionName, React.FC<IconProps>> => {
...
export const Icon = createFunctions<FunctionName>(functionNames as any);