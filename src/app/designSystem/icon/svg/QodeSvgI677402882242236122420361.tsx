...
const QodeSvgI677402882242236122420361: React.FC<IconProps> = ({
  ...
  return (
    ...
    >
      <g filter="url(#filter0_f_936_27995)">
        <circle
          cx="45.0001"
          cy="45.0003"
          r="38.3333"
          fill="url(#paint0_angular_936_27995)"
        />
      </g>
      <defs>
        <filter
          id="filter0_f_936_27995"
          x="8.05855e-05"
          y="0.000324726"
          width={width}
          height={height}
        ...
        >
          ...
          <feGaussianBlur
            ...
            result="effect1_foregroundBlur_936_27995"
          />
        </filter>
        <radialGradient
          id="paint0_angular_936_27995"
          cx="0"
          cy="0"
          r="1"
