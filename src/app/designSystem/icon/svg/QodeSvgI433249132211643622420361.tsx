...
const QodeSvgI433249132211643622420361: React.FC<IconProps> = ({
  ...
  return (
    ...
    >
      <g filter="url(#filter0_f_791_65256)">
        <circle
          cx="45"
          cy="44.9999"
          r="38.3333"
          fill="url(#paint0_angular_791_65256)"
        />
      </g>
      <defs>
        <filter
          id="filter0_f_791_65256"
          x="1.95503e-05"
          y="-0.00010252"
          width={width}
          height={height}
        ...
        >
          ...
          <feGaussianBlur
            ...
            result="effect1_foregroundBlur_791_65256"
          />
        </filter>
        <radialGradient
          id="paint0_angular_791_65256"
          cx="0"
          cy="0"
          r="1"
