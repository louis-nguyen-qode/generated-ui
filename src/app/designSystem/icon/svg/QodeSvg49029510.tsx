...
const QodeSvg49029510: React.FC<IconProps> = ({
  style: { width, height } = {
    width: "46",
    height: "46",
  },
  ...
  return (
    ...
    >
      ...
      />
      <g filter="url(#filter0_dd_490_29510)">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
      ...
      <defs>
        ...
        >
          ...
          <feBlend
            ...
            result="effect1_dropShadow_490_29510"
          />
          <feColorMatrix
            in="SourceAlpha"
            type="matrix"
          ...
          <feBlend
            mode="normal"
            in2="effect1_dropShadow_490_29510"
            result="effect2_dropShadow_490_29510"
          />
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect2_dropShadow_490_29510"
            result="shape"
          />
        </filter>
      </defs>
...
export default QodeSvg49029510
