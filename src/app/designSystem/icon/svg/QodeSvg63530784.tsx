...
const QodeSvg63530784: React.FC<IconProps> = ({
  style: { width, height } = {
    width: "100",
    height: "100",
  },
  ...
  return (
    ...
    >
      <g filter="url(#filter0_d_635_30784)">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
      ...
      <defs>
        ...
        >
          ...
          <feBlend
            ...
            result="effect1_dropShadow_635_30784"
          />
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect1_dropShadow_635_30784"
            result="shape"
          />
        </filter>
      </defs>
...
export default QodeSvg63530784
