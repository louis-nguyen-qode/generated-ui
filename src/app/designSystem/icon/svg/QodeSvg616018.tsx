...
const QodeSvg616018: React.FC<IconProps> = ({
  style: { width, height } = {
    width: "114",
    height: "99",
  },
  ...
  return (
    ...
    >
      <g filter="url(#filter0_d_6160_18)">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
      ...
      <defs>
        ...
        >
          ...
          <feBlend
            ...
            result="effect1_dropShadow_6160_18"
          />
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect1_dropShadow_6160_18"
            result="shape"
          />
        </filter>
      </defs>
