...
const QodeSvg145945908: React.FC<IconProps> = ({
  style: { width, height } = {
    width: "48",
    height: "48",
  },
  ...
  return (
    ...
    >
      <g opacity="0.3">
        <g filter="url(#filter0_dd_1459_45908)">
          <rect
            x="8.80669"
            y="8.80645"
            width={width}
        ...
        <g filter="url(#filter1_dd_1459_45908)">
          <rect
            x="10.8228"
            y="10.8226"
            width={width}
      ...
      <defs>
        ...
        >
          ...
          <feBlend
            ...
            result="effect1_dropShadow_1459_45908"
          />
          <feColorMatrix
            in="SourceAlpha"
            type="matrix"
          ...
          <feBlend
            mode="color-dodge"
            in2="effect1_dropShadow_1459_45908"
            result="effect2_dropShadow_1459_45908"
          />
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect2_dropShadow_1459_45908"
            result="shape"
          />
        </filter>
        <filter
          id="filter1_dd_1459_45908"
          x="0.000244141"
          y="0"
          width={width}
          height={height}
...
export default QodeSvg145945908
