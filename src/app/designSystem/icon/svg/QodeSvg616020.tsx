...
const QodeSvg616020: React.FC<IconProps> = ({
  style: { width, height } = {
    width: "100",
    height: "100",
  },
  ...
  return (
    ...
    >
      <g filter="url(#filter0_d_6160_20)">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
      ...
      <defs>
        ...
        >
          ...
          <feBlend
            ...
            result="effect1_dropShadow_6160_20"
          />
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect1_dropShadow_6160_20"
            result="shape"
          />
        </filter>
      </defs>
