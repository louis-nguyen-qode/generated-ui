...
const QodeSvg561044935: React.FC<IconProps> = ({
  style: { width, height } = {
    width: "20",
    height: "20",
  },
  ...
  return (
    ...
    >
      <g filter="url(#filter0_d_5610_44935)">
        <path
      ...
      <defs>
        ...
        >
          ...
          <feMorphology
            ...
            operator="dilate"
            in="SourceAlpha"
            result="effect1_dropShadow_5610_44935"
          />
          <feOffset />
          ...
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect1_dropShadow_5610_44935"
            result="shape"
          />
        </filter>
      </defs>
...
export default QodeSvg561044935
