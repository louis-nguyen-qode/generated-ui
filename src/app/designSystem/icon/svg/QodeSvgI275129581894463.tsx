...
const QodeSvgI275129581894463: React.FC<IconProps> = ({
  ...
  return (
    ...
    >
      <g clip-path="url(#clip0_6346_9383)">
        <path
        ...
        <path
          d="M0 6C0 2.6863 2.68629 0 6 0H250C253.314 0 256 2.68629 256 6V154C256 157.314 253.314 160 250 160H6C2.68629 160 0 157.314 0 154V6Z"
          fill="url(#paint0_linear_6346_9383)"
        />
        <path
          d="M0 6C0 2.6863 2.68629 0 6 0H250C253.314 0 256 2.68629 256 6V154C256 157.314 253.314 160 250 160H6C2.68629 160 0 157.314 0 154V6Z"
          fill="url(#paint1_linear_6346_9383)"
        />
