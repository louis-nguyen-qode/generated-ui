...
const QodeSvg27319253: React.FC<IconProps> = ({
  style: { width, height } = {
  ...
  return (
    ...
    >
      <g filter="url(#filter0_f_273_19253)">
        <circle
          cx="45.0001"
          cy="44.9998"
          r="38.3333"
          fill="url(#paint0_angular_273_19253)"
        />
      </g>
      <defs>
        <filter
          id="filter0_f_273_19253"
          x="8.05855e-05"
          y="-0.000163555"
          width={width}
          height={height}
        ...
        >
          ...
          <feGaussianBlur
            ...
            result="effect1_foregroundBlur_273_19253"
          />
        </filter>
        <radialGradient
          id="paint0_angular_273_19253"
          cx="0"
          cy="0"
          r="1"
...
export default QodeSvg27319253
